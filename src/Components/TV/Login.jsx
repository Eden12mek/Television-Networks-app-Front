...
const Login = () => {
    ...
    const handleLogin = async (event) => {
        ...
        try {
            ...
            if (response.data.access_token) {
                localStorage.setItem('userRole', response.data.foundUser.role);
    ...
    return (
        ...
        <Grid container spacing={2} justifyContent="center" alignItems="center" overflow='hidden'>
            <Grid item xs={12} md={6}>
                <img
                    ...
                    style={{ width: '100%', height: '965px', objectFit: 'cover' }} // Adjusted height
